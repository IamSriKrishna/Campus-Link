...
import 'package:campuslink/Widget/CustomActionSlide.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          FadeInLeft(child: LeaveDetailsWidget(text: 'Credit You Have',hint: '${student.credit}',)),
          //Diplay per Credit 
          FadeInLeft(child: LeaveDetailsWidget(text: 'Per Credit',hint: '${credit}',)),
          //Diplay no of days selected
          FadeInLeft(child: LeaveDetailsWidget(text: 'Total days selected',hint: '${calculateTotalDaysSelected()}',)),
          //Calulate no of days selected and credit
          FadeInLeft(child: LeaveDetailsWidget(text: 'Total Credit',hint: '${calculateTotalDaysSelected() * credit}',)),
          // Container(
